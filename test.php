...
if( !isset($_SERVER['SERVICE_NAME_APP']) ) {
    ...
    defined( 'SERVICE_APP_ROOT' ) or define( 'SERVICE_APP_ROOT', APP_ROOT . strtolower($_SERVER['SERVICE_NAME_APP']) . DIRECTORY_SEPARATOR  );//设置当前子系统的根目录
}
 ...
 * 2、完成路由
 */
\core\base\Zero::$app = new \core\base\web\WebApp($_SERVER['SERVICE_NAME_APP'], $config_path_list);
