...
class BaseController extends Controller
{
     ...
     * @var string
     */
    public $keywords = 'insisting,php技术博客后台管理系统';
     ...
     * @var string
     */
    public $title = 'insisting博客后台管理系统';
    ...
    public function beforeExecuteRoute($dispatcher)
    {
        ...
        $access_controll_list = $this->config->get('no_needed_login');
        ...
        if($this->is_login === true) {
           $forbidden_action_had_login = $this->config->get('forbidden_action_had_login'); 
           if(isset($forbidden_action_had_login[$controller_name]) && in_array($action_name, $forbidden_action_had_login[$controller_name][$action_name])) {
                return $this->response->redirect('/index/index');
           }
        } else {
            $allow_action_nologin = $this->config->get('allow_action_nologin');
            if($controller_name != 'acc' || $action_name != 'login') {
                if(!isset($allow_action_nologin[$controller_name]) || 
                                                                    !in_array($action_name, $allow_action_nologin[$controller_name])) {
                    if($login_data === false) {
    ...
    public function initHeader()
    {
        ...
        $article_status_list = $this->config->get('article_status_list');
        $this->view->setVar('article_status_list', $article_status_list);
    ...
    {
        $result = false; 
        $login_session_name = $this->config->get('admin_login_session_name');
